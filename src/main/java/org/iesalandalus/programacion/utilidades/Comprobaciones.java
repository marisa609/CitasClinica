...
public class Comprobaciones {
	...
	// En esta clase iré metiendo las comprobaciones que haya que ir realizando para
	// llamarla desde las clases que vaya a utilizar
	...
	public static String formateaNombre(String nombreObjeto) {
